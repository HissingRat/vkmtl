...
native parity 会拆开推进：Period31 压实第一个 Metal pixel-producing ray traced triangle，
Period32 压实第一个 Vulkan pixel-producing ray traced triangle，Period32+ 继续处理更广的
native coverage。
