...
split after Period30: Period31 owns the first Metal pixel-producing ray traced
triangle, Period32 owns the first Vulkan pixel-producing ray traced triangle,
and Period32+ owns broader native coverage.
