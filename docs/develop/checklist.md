...
- Period 56 is complete. Presentation request/selection, exact drawable
  ...
  and corrected canonical composition now both pass physical execution and
  visual orientation; the corrected canonical path completed 3000 frames.
...
- [x] Keep Vulkan RT physical validation explicit until it runs on a supported
  ...
  legacy and corrected canonical routes now both pass physical execution and
  visual orientation on the supported Vulkan RT machine.
