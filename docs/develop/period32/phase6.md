...
Phase 6 proves the Vulkan ray traced triangle path with real hardware or a real
...
- Run `zig build run-ray-traced-triangle -Dvulkan` on a supported Vulkan ray
  tracing setup.
