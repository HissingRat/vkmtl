...
Status: Period 56 complete, updated 2026-07-16. Vulkan legacy RT physical
execution/visual evidence is recorded; corrected canonical orientation remains
one device-matrix rerun.
...
flip; the fragment-position UV fix has Metal readback/build evidence and awaits
one corrected Vulkan visual rerun.
...
evidence is recorded; the canonical fragment-position UV fix needs one
corrected visual rerun. The exactly-once gap-routing file is empty because all 111
