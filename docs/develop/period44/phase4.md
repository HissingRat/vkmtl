...
Metal passed the default 120-iteration run; Vulkan soak evidence is missing.
...
and unsupported-feature failures. The current Metal run did not inject or
observe device loss; that evidence remains open in the parity report.
