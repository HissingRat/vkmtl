...
tone-mapping policy。旧 drawable dispatch command 仍为兼容保留。RT dispatch 与 fullscreen
...
backend，但早于 Period 55 shared presentation path。新的 Vulkan reference-preserving path 已有
unit 与 forced-build evidence，仍需在 Vulkan RT 机器上物理复跑。
