...
pub const examples = [_]ExampleEntry{
    ...
    .{
        ...
        .backend_expectation = "face-specific detailed atlas materials, bounded streaming/culling, automatic raster fallback, and capability-gated hybrid ray-traced sun/sky visibility on Vulkan or Metal",
    },
    .{
...
pub const backend_test_matrix = [_]BackendMatrixEntry{
    ...
    .{
        ...
        .backend = .metal,
        .required = false,
        .command = "MTL_DEBUG_LAYER=1 VKMTL_VOXEL_RT=off VKMTL_VOXEL_PROFILE=smoke VKMTL_VOXEL_FRAME_LIMIT=24 VKMTL_VOXEL_AUTOPILOT=1 VKMTL_BACKEND=metal zig build run-voxel-world && MTL_DEBUG_LAYER=1 VKMTL_VOXEL_RT=off VKMTL_VOXEL_PROFILE=default VKMTL_VOXEL_FRAME_LIMIT=96 VKMTL_BACKEND=metal zig build run-voxel-world && MTL_DEBUG_LAYER=1 VKMTL_VOXEL_RT=off VKMTL_VOXEL_PROFILE=stress VKMTL_VOXEL_FRAME_LIMIT=160 VKMTL_BACKEND=metal zig build run-voxel-world",
        .requires_runtime_configuration = true,
        .expectation = "the raster baseline drains bounded background CPU meshing for 9/169/289 smoke/default/stress resident sets under Metal API Validation and prints streaming_drained=true plus voxel_world_pressure_test=ok",
    },
    .{
        .name = "voxel_world_metal_ray_tracing",
        .host = .macos,
        .backend = .metal,
        .required = false,
        .command = "MTL_DEBUG_LAYER=1 VKMTL_BACKEND=metal VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=smoke VKMTL_VOXEL_FRAME_LIMIT=24 VKMTL_VOXEL_AUTOPILOT=1 VKMTL_VOXEL_CYCLE_TIME=0 zig build run-voxel-world && MTL_DEBUG_LAYER=1 VKMTL_BACKEND=metal VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=default VKMTL_VOXEL_FRAME_LIMIT=96 VKMTL_VOXEL_CYCLE_TIME=150 zig build run-voxel-world",
        .requires_runtime_configuration = true,
        .expectation = "Metal drains background CPU meshing, builds indexed chunk BLAS objects, traverses the complete 9/169-source smoke/default neighborhoods within the 289-source bound, validates finite nonzero direct, indirect, and reconstructed PTGI radiance with native driver submission, and prints ptgi_bounces=3",
    },
    .{
        .name = "voxel_world_vulkan_ray_tracing",
        .host = .windows,
        .backend = .vulkan,
        .required = false,
        .command = "VKMTL_BACKEND=vulkan VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=smoke VKMTL_VOXEL_FRAME_LIMIT=24 VKMTL_VOXEL_AUTOPILOT=1 VKMTL_VOXEL_CYCLE_TIME=0 zig build run-voxel-world -Dvulkan && VKMTL_BACKEND=vulkan VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=default VKMTL_VOXEL_FRAME_LIMIT=96 VKMTL_VOXEL_CYCLE_TIME=150 zig build run-voxel-world -Dvulkan",
        .requires_runtime_configuration = true,
        .expectation = "a Vulkan RT device drains background CPU meshing, covers complete 9/169-source smoke/default TLAS mapping within the 289-source bound, validates finite nonzero direct, indirect, and reconstructed PTGI radiance, and prints ptgi_bounces=3; this physical lane is currently pending",
    },
    .{
...
pub const validation_jobs = [_]ValidationJob{
    ...
    .{
        .name = "local_metal_voxel_ray_tracing",
        .host_os = .macos,
        .target_os = .macos,
        .architecture = "aarch64",
        .backend = .metal,
        ...
        .attach_capability_dump = true,
        .command = "MTL_DEBUG_LAYER=1 VKMTL_BACKEND=metal VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=smoke VKMTL_VOXEL_FRAME_LIMIT=24 VKMTL_VOXEL_AUTOPILOT=1 zig build run-voxel-world && MTL_DEBUG_LAYER=1 VKMTL_BACKEND=metal VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=default VKMTL_VOXEL_FRAME_LIMIT=96 VKMTL_VOXEL_CYCLE_TIME=150 zig build run-voxel-world",
    },
    .{
        .name = "local_windows_vulkan_voxel_ray_tracing",
        .host_os = .windows,
        .target_os = .windows,
        .architecture = "x86_64",
        .backend = .vulkan,
        ...
        .required_for_release = false,
        .attach_capability_dump = true,
        .command = "VKMTL_BACKEND=vulkan VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=smoke VKMTL_VOXEL_FRAME_LIMIT=24 VKMTL_VOXEL_AUTOPILOT=1 zig build run-voxel-world -Dvulkan && VKMTL_BACKEND=vulkan VKMTL_VOXEL_RT=required VKMTL_VOXEL_PROFILE=default VKMTL_VOXEL_FRAME_LIMIT=96 VKMTL_VOXEL_CYCLE_TIME=150 zig build run-voxel-world -Dvulkan",
    },
    .{
...
pub const ray_tracing_native_parity_matrix = [_]RayTracingNativeParityMatrixEntry{
    ...
    .{
        ...
        .deferred_to = "Period 32+ driver parity plan",
        .validation = "runtime acceleration structures own backend-private handle state; indexed voxel BLAS builds exercise geometry-specific Metal sizing and Vulkan native geometry input",
    },
    .{
        ...
        .vulkan_status = .portable_runtime,
        .metal_status = .portable_runtime,
        .validation = "planning validates transforms, masks, custom indices, material indices, mixed ranges, and SBT offsets; executable identity-instance TLAS builds accept one repeated source or exactly one source per instance",
    },
    .{
    ...
    .{
        ...
        .metal_status = .backend_private_runtime,
        .deferred_to = "Period 32+ driver parity plan",
        .validation = "runtime SBT objects own backend-private records; voxel-world dispatches caller-owned full-frame material-aware radiance through a bounded multi-BLAS TLAS",
    },
    .{
        ...
        .vulkan_status = .portable_runtime,
        .metal_status = .portable_runtime,
        .validation = "both backends write caller-owned textures and preserve per-dispatch state; voxel-world validates finite nonzero direct and indirect lighting before raster composition, while legacy drawable dispatch remains a validated raw BGRA8 copy",
    },
    .{
    ...
    .{
        ...
        .validation = "Metal execution mappings own backend-private function-table and acceleration-slot metadata; physical voxel evidence covers indexed BLAS, built TLAS admission, native traversal, and texture readback",
    },
    .{
    ...
    .{
        ...
        .public_api = "examples/ray_traced_scene and examples/voxel_world",
        .vulkan_status = .backend_private_runtime,
        .metal_status = .backend_private_runtime,
        .deferred_to = "Period 31 Phase 5 and Period 32 Phase 5",
        .validation = "ray_traced_scene verifies native color presentation, while voxel_world verifies bounded indexed chunk BLAS, multi-instance TLAS traversal, material-bound radiance, reconstruction readback, and raster consumption",
    },
};
...
pub const validation_cases = [_]ValidationCase{
    ...
    .{
        ...
        .test_location = "src/core.zig, src/runtime/window_context.zig, backend AS sizing/source-mapping tests, examples/ray_traced_scene, and examples/voxel_world finite RT runs",
        .expectation = "ray tracing gaps stay explicit while geometry-specific AS sizing, one/N TLAS source mapping, caller-owned dispatch, AS-kind validation, finite-run behavior, and material-bound direct/indirect radiance readback remain deterministic",
    },
    .{
    ...
    .{
        ...
        .test_location = "examples/voxel_world atlas/material/mode/mesher/camera/PTGI tests, raster pressure runs, Metal hybrid-RT physical lanes, and the pending Vulkan RT lane",
        .expectation = "raster smoke/default/stress drain bounded background CPU meshing within 9/169/289 resident limits; hybrid runs build indexed BLAS plus a complete bounded TLAS, validate finite nonzero direct/indirect/reconstructed radiance, require ptgi_bounces=3, expose streaming and RT metrics, and end with streaming_drained=true plus voxel_world_pressure_test=ok",
    },
};
